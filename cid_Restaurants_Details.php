...
//Store CID from drop down
$cid = $_GET['CID'];

// SQL statement
$sql = "SELECT * "
. "FROM ((RESTAURANTS_DETAILS r NATURAL JOIN IS_OF i) NATURAL JOIN RESTAURANT_TYPE t), SERVES s "
. "WHERE s.CID = $cid AND s.RID = r.RID ";
...
<!--Buttons that takes you to different pages -->
  ...
  <div class = "link">
      <p>
      <a href="output_cuisinetype.php">Return to list</a>
      </p>
  </div>
</div>
</body>
